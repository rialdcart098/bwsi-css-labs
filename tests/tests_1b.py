...
def test_addition():
    ...
    assert simple_calculator("add", 1.5, 1.5) == 3.0      # Test for fractions
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", 4.5, 0.5) == 4.0     # Test for fractions
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", 0.5, 2) == 1.0     # Test for fractions
